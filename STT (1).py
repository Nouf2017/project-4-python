# NOTE: this example requires  because it uses the Microphone class
...
# 'YOUR UNIQUE API KEY'
IBM_USERNAME = "j3VcqHChncFiuhwxvS2oJNnV2OjzW7fQ8NY3in-0pyvK"  
IBM_PASSWORD = "us-south"
